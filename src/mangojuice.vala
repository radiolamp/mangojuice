...
public class MangoJuice : Adw.Application {
    ...
    */
    ...
    void initialize_rest_of_ui (ViewStack view_stack) {
        ...
        cpu_switches[10].notify["active"].connect (() => {
            if (cpu_switches[10].active) cpu_switches[9].active = true;
        });
        cpu_switches[9].notify["active"].connect (() => {
            if (!cpu_switches[9].active) cpu_switches[10].active = false;
        });
